...
type TCustomPerson = class //Класс с data
 type
...
type TPerson = class(TCustomPerson) //текущий обьект разделение задач
  private
 ...
 type TPersonDB = class(TCustomPersonDB)                              ///////////////////
 public
